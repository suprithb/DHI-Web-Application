...
public class DHIConstants {
	...
	public static final String CA_USER_NOT_FOUND_ERROR="dhi_user_not_found_error";
	public static final String CA_200="200";
	public static final String CA_500="500";
	public static final String CA_SUCCESS = "success";
	public static final String CA_REPORT_ERROR = "dhi_report_error";
	
	public static final String CA_ENTITY_DELETED = "dhi_entity_deleted";
