...
public class MailServerUtil {
    ...
    public static boolean sendEmailWithOutAttachments(String toEmail,String message,String subject) throws DhiMessagingException, DhiSecurityException {
...
//
            ...
            /* InternetAddress[] mailAddress_TO = new InternetAddress [toAddress.length];
              ...
              Transport.send(msg);
				...
				e.printStackTrace();
				throw new DhiMessagingException("Got Error while sending email");
			}
