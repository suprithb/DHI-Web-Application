...
/*	public static void main(String[] args) throws IOException {
	...
	*/
	...
	public AIResponse invokeAI(ChatMessageRequest chatMessageRequest) {
		...
		if(aiResponse != null && aiResponse.getTabularData() != null && aiResponse.getTabularData().getGraphTypes() != null) {
			String graphTypes = aiResponse.getTabularData().getGraphTypes().get(0);
			aiResponse.getTabularData().setGraphTypes(Arrays.asList(graphTypes.split(",")));
