...
public class UserFavouriteServiceImpl implements UserFavouriteService{
	...
	/*public static void main(String[] args) {
		String fullUrl = "http://ipsolution.southindia.cloudapp.azure.com:8080/DHI/assets/test_user_bar_chart_vr_2019_05_21_23_55_30";
		
		
		ApplicationContext context = new FileSystemXmlApplicationContext("D:\\Development\\campaign_analytics\\DHI\\WebContent\\WEB-INF\\dhi-servlet.xml");
		
		//visualization_image_host
		String imageUrlPath = PropertiesConfigurationReader.getServerProperty("visualization_image_host");
		imageUrlPath += "/DHI/assets/";
