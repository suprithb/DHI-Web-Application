...
public interface AuthenAuthorService {
	...
	public GenericResponse registerUser(UserRegistration userRegistration)
			...
			MissingMandatoryParameterException, RegExPatternMismatchException, BdpMessagingException, DataAlreadyExistException, DhiSecurityException;
	...
	public GenericResponse forgotPassword(String email)
			throws MissingMandatoryParameterException, NoRecordFoundException, BdpMessagingException, InvalidCredentialException, DhiSecurityException;
